...
export type PropertyKeyType<T> = T extends z.ZodRawShape ? FlattenKeys<T> : T extends Record<string, any> ? FlattenObjectKeys<T> : never;
export type PropertyEditType = 'string' | 'integer' | 'real' | 'static-enum' | 'foreign-key' | 'boolean' | 'date' | 'time' | 'date-time' | 'custom';
...
export type ExtraPropertyOptions<T extends ExtraPropertyOptionSelectLike = ExtraPropertyOptionSelectLike> = ExtraPropertyOptionsNoComponent | ExtraPropertyOptionsTextInput | ExtraPropertyOptionsTextarea | ExtraPropertyOptionsSelect<T> | ExtraPropertyOptionsToggleOrCheckbox<T> | ExtraPropertyOptionsRadio<T>;
