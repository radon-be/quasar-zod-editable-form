import { inject, provide, type InjectionKey, type Ref, type App } from 'vue'
import type { I18nLabels } from '../types/form.type'

export const ZodFormI18nKey: InjectionKey<Ref<Partial<I18nLabels>>> = Symbol.for('ZodFormI18n')
 ...
 */
export function provideZodFormI18n(i18n: Ref<Partial<I18nLabels>>, app?: App) {
  if (app) {
 ...
 * app.use(createZodFormI18nPlugin(ref({ confirm: 'Opslaan', reset: 'Annuleren' })))
 */
export function createZodFormI18nPlugin(i18n: Ref<Partial<I18nLabels>>) {
  return {
    install(app: App) {
      app.provide(ZodFormI18nKey, i18n)
    },
 ...
 */
export function useZodFormI18n(): Ref<Partial<I18nLabels>> | null {
